...
const customParseFormat_1 = __importDefault(__webpack_require__(8225));
...
function reportWorkflowMetrics() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { userLoadX, systemLoadX, userTable, systemTable } = yield getCPUStats();
...
function getCPUStats() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const userTable = { max: maxUserValue, avg: (sumUserValue / duration).toFixed(2) };
        const systemTable = { max: maxSystemValue, avg: (sumSystemValue / duration).toFixed(2) };
